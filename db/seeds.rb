...
Sport.create!(category: "Badminton",name:"Singles",
 total_players: 2, description: "Badminton is a game played on a rectangular court by two players or two pairs of players equipped with light rackets used to volley a shuttlecock over a high net that divides the court in half.", video_url: "https://www.youtube.com/watch?v=rrjCTSOU5Z8"
 )
Sport.create!(category: "Badminton",name:"Doubles",
 total_players: 4, description: "Badminton is a game played on a rectangular court by two players or two pairs of players equipped with light rackets used to volley a shuttlecock over a high net that divides the court in half.", video_url:"https://www.youtube.com/watch?v=RWrD5FZAYrE"
 )
